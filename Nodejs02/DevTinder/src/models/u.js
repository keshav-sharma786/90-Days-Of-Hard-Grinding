...
//&see we already have the us model so what will be the plural of u.js/u afcourse us,so it will save the roman reigns under the same collection us with Brock Lesnar.

export const John = mongoose.model("U", userSchema);
